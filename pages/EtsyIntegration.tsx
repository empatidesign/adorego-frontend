            ...
            <main className="flex-grow pt-20">
                ...
                <section className="text-white relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #102477 0%, #1a3a9e 50%, #102477 100%)', paddingTop: '100px', paddingBottom: '80px' }}>
                    ...
                    <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
                        ...
                        <h1 className="text-4xl lg:text-5xl font-bold tracking-tight mb-4">Etsy Entegrasyonu</h1>
                        <p className="text-white/70 text-lg max-w-2xl">Etsy mağazanızdaki siparişleri AdoreGo ile otomatik yönetin. El yapımı ürünlerinizi dünyaya gönderin.</p>
                    </div>
                </section>
                ...
                <section className="py-20 bg-white">
                    <div className="max-w-5xl mx-auto px-6 lg:px-8">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                { icon: 'fa-sync-alt', title: 'Otomatik Sipariş Senkronizasyonu', desc: 'Etsy mağazanızdaki siparişler otomatik olarak AdoreGo paneline aktarılır. Manuel veri girişine son.' },
                                ...
                                { icon: 'fa-truck', title: 'Takip Numarası Otomatik Güncelleme', desc: 'Kargo takip numaraları otomatik olarak Etsy mağazanıza ve müşterilerinize iletilir.' },
                            ].map((feature, index) => (
                ...
                <section className="py-20 bg-gradient-to-r from-[#102477] to-[#1a3a9e] text-white">
                    <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
                        <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center mx-auto mb-8">
                            <i className="fab fa-etsy text-[#4DB848] text-2xl"></i>
                        </div>
                        <h2 className="text-3xl font-bold tracking-tight mb-4">Etsy Mağazanızı Hemen Bağlayın</h2>
                        <p className="text-white/70 text-lg max-w-2xl mx-auto mb-8">
                            Ücretsiz üye olun ve Etsy entegrasyonunu dakikalar içinde aktif edin.
                        </p>
                        <a
