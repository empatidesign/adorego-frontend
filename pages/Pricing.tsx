                                            ...
                                            filteredCountries.map((country: any, idx: number) => (
                                                <tr key={idx} className="group">
                                                    ...
                                                    <td className="py-6 px-6 text-right bg-gray-50 rounded-r-2xl group-hover:bg-[#102477]/5 transition-colors">
                                                        <button className="bg-[#102477] text-white px-6 py-2 rounded-lg text-sm font-bold hover:bg-[#0a1a5a] transition-all transform hover:scale-105 active:scale-95 shadow-md">
