                ...
                <section className="text-white relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #102477 0%, #1a3a9e 50%, #102477 100%)', paddingTop: '100px', paddingBottom: '80px' }}>
                    ...
                    <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
                        <nav className="flex items-center gap-2 text-sm opacity-60 mb-6">
                            ...
                            <span>/</span>
                            <span>Özel Site (API)</span>
                        </nav>
                        <h1 className="text-4xl lg:text-5xl font-bold tracking-tight mb-4">Özel Site Entegrasyonu (API)</h1>
                        <p className="text-white/70 text-lg max-w-2xl">Kendi e-ticaret sitenizi AdoreGo API ile entegre edin. RESTful API dokümantasyonu ve teknik destek.</p>
                    </div>
                </section>
                ...
                <section className="py-20 bg-white">
                    <div className="max-w-5xl mx-auto px-6 lg:px-8">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                { icon: 'fa-code', title: 'RESTful API', desc: 'Modern ve iyi dokümante edilmiş RESTful API ile sitenizi kolayca entegre edin. JSON formatında veri alışverişi.' },
                                { icon: 'fa-bell', title: 'Webhook Desteği', desc: 'Sipariş durumu değişikliklerinde otomatik bildirim alın. Gerçek zamanlı veri senkronizasyonu sağlayın.' },
                                { icon: 'fa-flask', title: 'Sandbox Test Ortamı', desc: 'Canlıya almadan önce sandbox ortamında entegrasyonunuzu test edin. Güvenli geliştirme süreci.' },
                            ].map((feature, index) => (
                ...
                <section className="py-20 bg-gradient-to-r from-[#102477] to-[#1a3a9e] text-white">
                    <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
                        <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center mx-auto mb-8">
                            <i className="fas fa-plug text-[#4DB848] text-2xl"></i>
                        </div>
                        <h2 className="text-3xl font-bold tracking-tight mb-4">API Entegrasyonuna Hemen Başlayın</h2>
                        <p className="text-white/70 text-lg max-w-2xl mx-auto mb-8">
                            Ücretsiz üye olun, API anahtarınızı alın ve entegrasyonunuzu başlatın.
                        </p>
                        <a
