            ...
            <main className="flex-grow pt-20">
                ...
                <section className="text-white relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #102477 0%, #1a3a9e 50%, #102477 100%)', paddingTop: '100px', paddingBottom: '80px' }}>
                    ...
                    <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
                        ...
                        <h1 className="text-4xl lg:text-5xl font-bold tracking-tight mb-4">Sıkça Sorulan Sorular</h1>
                        <p className="text-white/70 text-lg max-w-2xl">En çok merak edilen sorular ve cevapları</p>
                    </div>
                </section>
                ...
                <section className="py-20 bg-white">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
                        <div className="bg-slate-50 rounded-2xl p-16 border border-gray-100">
                            <div className="w-20 h-20 bg-[#102477]/10 rounded-2xl flex items-center justify-center mx-auto mb-8">
                                <i className="fas fa-question-circle text-[#102477] text-3xl"></i>
                            </div>
                            <p className="text-gray-500 text-lg mb-8">
                                Sorular yakında eklenecektir. Merak ettiğiniz konular için bize ulaşın.
                            </p>
                            <Link
                                to="/iletisim"
