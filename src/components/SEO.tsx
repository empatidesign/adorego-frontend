...
const SEO: React.FC<SEOProps> = ({
  ...
  const [seoData, setSeoData] = useState<any>({
    title: currentLang === 'tr' 
      ? 'AdorelGo - Yurtdışı ve Yurtiçi Kargo | Akıllı Lojistik Platformu'
      : 'AdorelGo - International & Domestic Shipping | Smart Logistics Platform',
    ...
    ogTitle: currentLang === 'tr'
      ? 'AdorelGo - E-Ticaret için Akıllı Lojistik Çözümleri'
      : 'AdorelGo - Smart Logistics Solutions for E-Commerce',
    ...
    ogImage: 'https://adorelgo.com/og-image.jpg',
    twitterCard: 'summary_large_image',
    twitterTitle: currentLang === 'tr'
      ? 'AdorelGo - E-Ticaret Lojistik Platformu'
      : 'AdorelGo - E-Commerce Logistics Platform',
    ...
    twitterImage: 'https://adorelgo.com/og-image.jpg',
    canonical: 'https://adorelgo.com',
    robots: 'index, follow',
    author: 'AdorelGo',
    ...
    structuredData: {
      ...
      "url": "https://adorelgo.com",
      "logo": "https://adorelgo.com/logo.png",
      "contactPoint": {
        "@type": "ContactPoint",
      ...
      "sameAs": [
        "https://www.instagram.com/adorelgo",
        "https://www.linkedin.com/company/adorelgo"
      ],
      "offers": {
        "@type": "AggregateOffer",
        "description": currentLang === 'tr'
  ...
  const title = titleProp || customTitle || seoData.title;
  const description = descriptionProp || customDescription || seoData.description;
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="AdorelGo" />
      ...
      {/* Language Alternates */}
      <link rel="alternate" hrefLang="tr" href="https://adorelgo.com" />
      <link rel="alternate" hrefLang="en" href="https://adorelgo.com/en" />
      <link rel="alternate" hrefLang="x-default" href="https://adorelgo.com" />
