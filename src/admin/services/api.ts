...
export const contentAPI = {
  ...
  getInternational: async (lang: string = 'tr') => {
    const response = await api.get(`/content/international?lang=${lang}`);
    return response.data;
  },
  updateInternational: async (data: any, lang: string = 'tr') => {
    const response = await api.put('/content/international', { data, lang });
    return response.data;
  },
  getAbout: async (lang: string = 'tr') => {
    const response = await api.get(`/content/about?lang=${lang}`);
    return response.data;
  },
  updateAbout: async (data: any, lang: string = 'tr') => {
    const response = await api.put('/content/about', { data, lang });
    return response.data;
  },
  getContact: async (lang: string = 'tr') => {
    const response = await api.get(`/content/contact?lang=${lang}`);
    return response.data;
  },
  updateContact: async (data: any, lang: string = 'tr') => {
    const response = await api.put('/content/contact', { data, lang });
    return response.data;
  },
  getTracking: async (lang: string = 'tr') => {
    const response = await api.get(`/content/tracking?lang=${lang}`);
    return response.data;
  },
  updateTracking: async (data: any, lang: string = 'tr') => {
    const response = await api.put('/content/tracking', { data, lang });
    return response.data;
  },
  getDomestic: async (lang: string = 'tr') => {
    const response = await api.get(`/content/domestic?lang=${lang}`);
    return response.data;
  },
  updateDomestic: async (data: any, lang: string = 'tr') => {
    const response = await api.put('/content/domestic', { data, lang });
    return response.data;
  },
  getHomeCta: async (lang: string = 'tr') => {
    const response = await api.get(`/content/home-cta?lang=${lang}`);
    return response.data;
  },
  updateHomeCta: async (data: any, lang: string = 'tr') => {
    const response = await api.put('/content/home-cta', { data, lang });
    return response.data;
  },
  getUseCases: async (lang: string = 'tr') => {
    const response = await api.get(`/content/usecases?lang=${lang}`);
    return response.data;
  },
  updateUseCases: async (data: any, lang: string = 'tr') => {
    const response = await api.put('/content/usecases', { data, lang });
    return response.data;
  },
};
