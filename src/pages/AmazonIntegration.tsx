...
const AmazonIntegration: React.FC = () => {
    ...
    const title = cms?.title || 'Amazon Entegrasyonu';
    const subtitle = cms?.description || 'Amazon mağazanızı entegre edin, FBA ve FBM siparişlerinizi tek panelden yönetin.';
            ...
            <main className="flex-grow pt-20">
                ...
                <section className="py-20 bg-gradient-to-r from-[#102477] to-[#1a3a9e] text-white">
                    <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
                        ...
                        <p className="text-white/70 text-lg max-w-2xl mx-auto mb-8">Ücretsiz üye olun ve Amazon entegrasyonunu dakikalar içinde aktif edin.</p>
