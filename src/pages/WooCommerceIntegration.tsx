...
const WooCommerceIntegration: React.FC = () => {
    ...
    const title = cms?.title || 'WooCommerce Entegrasyonu';
    const subtitle = cms?.description || 'WordPress sitenizi AdorelGo ile entegre edin, WooCommerce siparişlerinizi otomatik kargolayın.';
    const sections: any[] = (cms?.sections && cms.sections.length > 0) ? cms.sections : DEFAULT_SECTIONS;

    return (
        <div className="flex flex-col min-h-screen overflow-x-hidden">
            <SEO page="woocommerce-entegrasyonu" />
            <Navbar />
            <main className="flex-grow pt-20">
                ...
                <section className="py-20 bg-gradient-to-r from-[#102477] to-[#1a3a9e] text-white">
                    <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
                        ...
                        <h2 className="text-3xl font-bold tracking-tight mb-4">WooCommerce Sitenizi Hemen Bağlayın</h2>
                        <p className="text-white/70 text-lg max-w-2xl mx-auto mb-8">Ücretsiz üye olun ve WooCommerce entegrasyonunu dakikalar içinde aktif edin.</p>
