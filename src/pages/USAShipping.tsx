...
const USAShipping: React.FC = () => {
    ...
    const title = cms?.title || "Amerika'ya Kargo";
    const subtitle = cms?.description || "Türkiye'den ABD'ye hızlı, güvenli ve uygun fiyatlı kargo gönderimi";
            ...
            <main className="flex-grow pt-20">
                ...
                <section className="py-6 bg-gradient-to-r from-[#102477] to-[#1a3a9e] text-white">
                    <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
                        ...
                        <p className="text-white/70 text-lg max-w-2xl mx-auto leading-relaxed mb-8">Ücretsiz üye olun, fiyatları karşılaştırın ve kargonuzu ABD'ye gönderin.</p>
