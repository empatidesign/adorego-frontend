...
const IntlShippingPrices: React.FC = () => {
    ...
    const title = cms?.title || 'Yurtdışı Kargo Fiyatları';
    const subtitle = cms?.description || '2026 güncel yurtdışı kargo fiyatlarını karşılaştırın';
    const sections: any[] = (cms?.sections && cms.sections.length > 0) ? cms.sections : DEFAULT_SECTIONS;

    return (
        <div className="flex flex-col min-h-screen overflow-x-hidden">
            <SEO page="yurtdisi-kargo-fiyatlari" customTitle="Yurtdışı Kargo Fiyatları 2026 | AdorelGo" customDescription="Yurtdışı kargo fiyatları 2026 güncel liste." />
            <Navbar />
            <main className="flex-grow pt-20">
                ...
                <section className="py-20 bg-gradient-to-r from-[#102477] to-[#1a3a9e] text-white">
                    <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
                        ...
                        <p className="text-white/70 text-lg max-w-2xl mx-auto leading-relaxed mb-8">Ücretsiz üye olun, gönderi bilgilerinizi girin ve tüm fiyatları anında karşılaştırın.</p>
